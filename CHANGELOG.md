...
### Fixed
- 🌊 **Wan Request** - Fixed request wan functionality
  - Improved request handling for Wan video generation service
...
[0.2.0]: https://github.com/eternalai-org/typescript-sdk/releases/tag/v0.2.0
[0.1.1]: https://github.com/eternalai-org/typescript-sdk/releases/tag/v0.1.1
[0.1.0]: https://github.com/eternalai-org/typescript-sdk/releases/tag/v0.1.0
